...
<head>
    ...
    <title>Teste UEX - Cadastrar</title>
...
<body class="text-center">
    <main class="form-signin">
        ...
        @endif
        <form method="POST" name="register" action="{{ route('login.storeUser') }}"">
          @csrf
            ...
            <button class="w-100 btn btn-lg btn-primary" type="submit" disabled>Salvar</button>
