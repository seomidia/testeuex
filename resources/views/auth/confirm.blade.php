...
<head>
    ...
    <title>Teste UEX - Confirmar Senha para deletar a conta</title>
...
<body class="text-center">
    <main class="form-signin">
        ...
        <form action="{{ route('admin.AccontDeleteConfirm') }}" method="POST">
            @csrf
            <svg width="200" version="1.1" id="Camada_1" fill="currentColor" xmlns="https://www.w3.org/2000/svg"
                ...
                c0-4.5,1.3-8.5,3.3-10.6c3.2-3.3,7.2-6.6,18-5.8c6.3-0.1,13,4.2,13,8.9C164.1,73,158.6,75.3,148.9,75.3z">
                    </path>
                    <g>
                        <g>
            ...
            <h1 class="h3 mb-3 fw-normal">Confirmar Senha para deletar a conta</h1>
