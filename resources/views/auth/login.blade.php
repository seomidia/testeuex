    ...
    <main class="form-signin">
      ...
      @endif
        <form method="POST" action="{{route('login.auth')}}">
          @csrf
            <svg width="200" version="1.1" id="Camada_1" fill="currentColor" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 420 170.9" style="enable-background:new 0 0 420 170.9;" xml:space="preserve" alt="Logo-UEX.IO">
                <g>
                  ...
                  <path class="st0" d="M148.8,35.2c-31.2,0-45.9,15.5-45.9,46.6c0,33.1,14.3,49.7,45,49.7c26.3,0.5,38.4-8.2,38.2-14.2l-0.3-8.4
                  ...
                  <g>
                    <g>
                      ...
                      <path class="st2" d="M245.3,146.7v14.6c0,5.9-3,8.7-8.7,8.7c-3.1,0-6.2-0.9-8-2.5l1.5-2.4c1.6,1.3,4,2.2,6.5,2.2
                        ...
                        H245.3z M242.3,154.7c0-3.3-2.4-5.5-5.8-5.5c-3.4,0-5.8,2.2-5.8,5.5c0,3.2,2.4,5.5,5.8,5.5C239.9,160.2,242.3,158,242.3,154.7z"></path>
            ...
            <div class="form-floating">
                <input type="password" class="form-control" name="password" id="floatingPassword" placeholder="Senha" value="{{old('password')}}">
                <label for="floatingPassword">Senha</label>
            </div>
            <button class="w-100 btn btn-lg btn-primary" type="submit">Logar</button>
            <div class="checkbox mb-3">
                <label>
                  <a href="{{route('login.createUser')}}"> Cadastre-se</a><br/>
                  <a href="{{route('login.forget')}}"> Lembrar Senha</a>
                </label>
              </div>
